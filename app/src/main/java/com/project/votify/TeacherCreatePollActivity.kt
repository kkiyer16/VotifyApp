...
import com.project.votify.databinding.ActivityTeacherCreatePollBinding

class TeacherCreatePollActivity : AppCompatActivity() {

    lateinit var binding: ActivityTeacherCreatePollBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTeacherCreatePollBinding.inflate(layoutInflater)
        ...
        cardsAdap = cardsAdapter(modelnames.pollpos, 1)
        ...
        dbRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                fBase.child("Votify").child("Institution").child(clg_uid).child("CandidateData")
                    .orderByChild("coursename").equalTo(courseName)
