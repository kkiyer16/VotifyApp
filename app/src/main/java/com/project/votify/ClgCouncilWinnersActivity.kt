...
import com.project.votify.databinding.ActivityClgCouncilWinnersBinding
import com.project.votify.models.User
import com.project.votify.models.modelnames

class ClgCouncilWinnersActivity : AppCompatActivity() {

    lateinit var binding: ActivityClgCouncilWinnersBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityClgCouncilWinnersBinding.inflate(layoutInflater)
        ...
        arrayList = ArrayList()
        binding.clgcWinnerRecyclerView.setHasFixedSize(true)
        val linearLayoutManager = LinearLayoutManager(applicationContext)
        binding.clgcWinnerRecyclerView.layoutManager = linearLayoutManager
        cardsAdap = cardsAdapter(modelnames.clgcouncilwinners, 4)
        cardsAdap.set(arrayList, applicationContext)
        binding.clgcWinnerRecyclerView.adapter = cardsAdap
